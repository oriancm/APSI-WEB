...
<body class="bg-gray-100 font-sans">
    <main class="max-w-4xl mx-auto py-8 px-4">
        ...
        <div class="mb-6 flex space-x-4">
            ...
            <a href="/reference/<?= $id ?>" class="inline-flex items-center px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors duration-200">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
